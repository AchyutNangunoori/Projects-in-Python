...
if __name__ == "__main__":  
	...
	expression_field.grid(columnspan=4,ipadx=70,ipady=15)
	...
	modulus = Button(gui, text=' % ', fg='black', bg='white', command=lambda: press("%"), height=1, width=7) 
	modulus.grid(row=6, column=0, padx = 1, pady = 1)
	...
	Decimal.grid(row=6, column=1, padx = 1, pady = 1) 
	gui.mainloop() 
